...
class Music(commands.Cog):
    ...
    @commands.command(
        help="Make me join in a VC", aliases=["join"], invoke_without_subcommand=True
    )
    ...
    @commands.command(
        help="See the actual song in playing", aliases=["now", "current", "playing"]
    )
    ...
    @commands.command(name="play", help="Play a song in a VC", aliases=["p"])
